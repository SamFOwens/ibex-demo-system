...
se_imd_val_we_o = {1'b0, ready_o} | internal_se_alu_imd_val_we; // Keeps track of whether either Keyexpand is done or the appropriate decrypt + alu op combo is done
